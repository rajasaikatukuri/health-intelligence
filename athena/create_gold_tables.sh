#!/bin/bash
# Create gold tables for Health Intelligence Platform
# This creates tables without tenant filtering (they're partitioned by tenant_id)
...
echo "=========================================="
echo "Creating Gold Tables in Athena"
echo "=========================================="
echo ""
